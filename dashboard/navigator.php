     ...
     <li><a class='text-white text-decoration-none' href='../index.php'><span class='fa fa-house'></span> Home</a></li>
         ...
         <li class='position-relative'><a class='text-white text-decoration-none active-link-notification' href='notifications.php'><span class='fa fa-bell'></span> Notifications <span style='font-size:13px;' class='fa fa-circle text-danger position-absolute'></span></a></li>
