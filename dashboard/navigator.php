     <ul class='d-flex flex-row flex-column justify-content-center align-items-center gap-5 navigator full-height shadow-lg list-unstyled px-4 py-4'>
         ...
         <li class='position-relative'><a class='text-white text-decoration-none active-link-notification' href='notifications.php'><span class='fa fa-bell'></span> Notifications</a><span style='font-size:13px;' class='fa fa-circle text-danger position-absolute'></span></li>
